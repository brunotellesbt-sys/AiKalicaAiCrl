...
export const gymLeadersByGeneration: Record<number, GymLeader[]> = {
    ...
    3: [
      ...
      {
        name: 'gymLeaders.juan.name',
        sprite: "https://play.pokemonshowdown.com/sprites/trainers/juan.png",
        quotes: [
          "gymLeaders.juan.quote1",
          "gymLeaders.juan.quote2"
        ]
      },
    ],
    4: [
