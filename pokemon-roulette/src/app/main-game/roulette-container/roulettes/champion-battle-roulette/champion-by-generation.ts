...
export const championByGeneration: Record<number, GymLeader[]> = {
    1: [
        {
            // Japanese/Adventures naming: the Kanto Champion is Green, the same person as
            // the rival. "Blue" is the girl, who appears as the counterpart protagonist.
            name: 'Green',
    ...
    3: [
        {
            ...
            quotes: [
                "Let us see how you and your Pokémon have grown!",
                "Show me the power of your bond in this final battle!"
            ]
        }
    ],
    4: [
