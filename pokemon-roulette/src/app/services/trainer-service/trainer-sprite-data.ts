export const trainerSpriteData: { [generation: number]: { [gender: string]: string } } = {
        ...
        9: {
            // Use Pokémon Showdown sprites to avoid hotlink blocks seen on some wiki hosts.
            male: 'https://play.pokemonshowdown.com/sprites/trainers/florian-s.png',
            female: 'https://play.pokemonshowdown.com/sprites/trainers/juliana-s.png'
        }
}
